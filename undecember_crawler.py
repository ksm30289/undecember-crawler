...
KEYWORDS = ['버그', '불가', '스킬', '패치', '오류', '에러', '문제', '속보', '장난', '꿀통', '중복', '복사', '암흑', '섭섭', '병신', '안돼', '안되', '보상', '드랍', '접속', '불법', '망함', '역대급', '드롭', '제발', '●', '최적화', '건의', '개선', '너프', '버프', '운영', '다크', '닼디', '언디2', '언디셈버2']
...
CREDS = Credentials.from_service_account_file('C:/Users/LG/Desktop/credentials.json', scopes=SCOPES)
